...
import engine.render.renderers.NormalMappingRenderer;
import org.lwjgl.opengl.Display;
import org.lwjgl.opengl.GL11;
import org.lwjgl.util.vector.Matrix4f;
import org.lwjgl.util.vector.Vector4f;
import engine.render.renderers.EntityRenderer;
import engine.render.renderers.TerrainRenderer;
import engine.render.utils.Loader;
import engine.shaders.StaticShader;
import engine.shaders.TerrainShader;
import engine.render.renderers.SkyboxRenderer;
...
public class MasterRenderer {
	...
	public void renderScene(List<Entity> entities, List<Entity> normalEntities, List<Terrain> terrains, List<Light> lights,
		...
		normalEntities.forEach(this::processNormalMapEntity);
